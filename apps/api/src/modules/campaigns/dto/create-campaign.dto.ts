...
export const createCampaignSchema = z
  .object({
    ...
    template_id: z
      .string()
      .uuid('template_id deve ser um UUID valido')
      .optional(),
    ...
    delay_min: z.number().int().min(5, 'Delay minimo e 5 segundos').default(8),
    delay_max: z
      .number()
      .int()
  ...
  .refine((data) => data.template_id || data.inline_message, {
    message: 'Informe um template ou uma mensagem direta',
    path: ['template_id'],
  });
